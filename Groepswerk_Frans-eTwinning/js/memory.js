...
;(function( window ) {
  ...
  Memory.prototype._setupGame = function() {
    ...
    this.gameMetaHTML = '<div class="mg__meta--left">\
      ...
      <span class="mg__meta--moves">tentatives: \
    ...
    this.gameStartScreenHTML = '<h2 class="mg__start-screen--heading">Bienvenue sur le jeux de Memory!</h2>\
      <p class="mg__start-screen--text"></p>\
      <h3 class="mg__start-screen--sub-heading">choisir le niveau</h3>\
      ...
      <li><span data-level="3">Niveau 3 - Professionnel (8 x 4)</span></li>\
      </ul>';
  ...
  Memory.prototype._winGame = function() {
    ...
    if (this.options.onGameEnd() === false) {
      this._clearGame();
      this.gameMessages.innerHTML = '<h2 class="mg__onend--heading">Chouette !</h2>\
        <p class="mg__onend--message">Vous avez gagné en ' + this.numMoves + ' tentatives. Allez-y!.</p>\
        <button id="mg__onend--restart" class="mg__button">Réessayer?</button>';
